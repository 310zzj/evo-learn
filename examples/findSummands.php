<?php
	...
	echo "Solution found by the fittest specimen: ".$specimen->getDna()->getGene("summandA")->getValue()." + ".$specimen->getDna()->getGene("summandB")->getValue()." = ".($specimen->getDna()->getGene("summandA")->getValue() + $specimen->getDna()->getGene(